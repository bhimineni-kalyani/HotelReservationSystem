...
import static com.bridgelabz.Date.extractDate;

public class HotelReservationSystem4 {
    private ArrayList<Hotel> hotelList;

    public HotelReservationSystem4() {
    ...
    public Object getCheapestHotels(String from_date, String to_date) throws InvalidDateExceptions {
