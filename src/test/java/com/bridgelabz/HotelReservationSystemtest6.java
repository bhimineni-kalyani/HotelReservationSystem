...
public class HotelReservationSystemtest6 {
    private HotelReservationSystem6 hotelReservationSystem6;
    ...
    public void init() {
        ...
        hotelReservationSystem6 = new HotelReservationSystem6();
        hotelReservationSystem6.printWelcomeMessage();
        hotelReservationSystem6.add(lakewood);
        hotelReservationSystem6.add(bridgewood);
        hotelReservationSystem6.add(ridgewood);
    }

    @Test
    public void givenHotelsInTheSystem_ShowAllTheHotelNames_ShouldReturnProperHotel() {
        String names = hotelReservationSystem6.getHotelNames();
    ...
    public void givenHotelsInTheSystem_ShouldReturnTheCheapestHotelList_WithinGivenDates() throws InvalidDateExceptions {
        ...
        Map<Hotel, Integer> map = hotelReservationSystem6.getCheapestHotels(date1, date2);
    ...
    public void givenHotelsInTheSystem_ShouldReturnItsWeekDayAndWeekendDayRate() {
        String hotelListRates = hotelReservationSystem6.printNameWeekDayAndWeekendRates();
    ...
    public void givenHotelsInTheSystem_ShouldReturnProperRatingsAsAssigned() {
        String result = hotelReservationSystem6.printNamesAndRating();
    ...
    public void givenHotelsInTheSystem_ShouldReturnTheBestCheapestHotelsInTheSystem_WithinGivenRangeOfDate() throws InvalidDateExceptions {
        String date1 = "11Sep2020";
        String date2 = "12Sep2020";
        Map<Hotel, Integer> map = hotelReservationSystem6.getBestRatedCheapestHotels(date1, date2);
